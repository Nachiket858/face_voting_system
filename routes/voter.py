...
#     # Fetch voter details including location
#     voter = voters_collection.find_one({"_id": voter_id}, {"name": 1, "location": 1})
#     if not voter:
#         flash("Voter not found!", "danger")
#         return redirect(url_for("voter_bp.login"))
...
#     candidates = election.get("candidates", [])  # Ensure candidates is a list of dictionaries
