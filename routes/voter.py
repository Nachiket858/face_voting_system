...
# Project: Facial Recognition-Based Voting System
# Developed by: KodeNeurons Team  and Mountreach Solution
# For detailed information, visit:
# https://kodeneurons.vercel.app
...
def vote(election_id):
    ...
    if request.method == "POST":
        ...
        if distance > 9:  # Adjust threshold if needed
...
def dashboard():
    ...
    completed_elections = list(elections_collection.find({
    ...
    return render_template(
        ...
        ongoing_elections=ongoing_elections,
        upcoming_elections=upcoming_elections,
        completed_elections=completed_elections,  # Pass completed elections to template
        voted_election_ids=voted_election_ids
    )